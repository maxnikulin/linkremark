...
lr_content_scripts.lrcRelations = function lrcRelations() {
	...
	try {
		const properties = [
			...
			{ getter: lrIsTopWindow, property: "frame_relations", key: "window.isTop" },
			{ getter: lrActiveElementNodeName, property: "frame_relations", key: "document.activeElement.nodeName" },
			{ getter: lrActiveElementHref, property: "frame_relations", key: "document.activeElement.href" },
			{ getter: lrActiveElementSrc, property: "frame_relations", key: "document.activeElement.src" },
			{ getter: lrWindowParent, property: "referrer", key: "window.parent" },
			{ getter: lrHasFocus, property: "frame_relations", key: "document.hasFocus" },
			{ getter: lrFocusedTags, property: "frame_relations", key: "document.focusedTags" },
