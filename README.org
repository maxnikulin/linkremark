...
or from browser add-ons page[fn:1].
...
through a native messaging application as a safer option.[fn:3]
...
you should do something like[fn:4] (Linux, Firefox)
...
similar[fn:4] to the following one:
...
Open LinkRemark settings page[fn:1]. Set "Name of native messaging backend
...
"Exchange messages with other programs".
...
Open browser extensions preferences[fn:1] to manage this set of permissions.
...
[fn:1] "Manage extension" or "Preferences" in context menu (right click)
...
[fn:3] There is a problem with browsers distributed
