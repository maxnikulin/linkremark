...
Install [[https://addons.mozilla.org/firefox/addon/linkremark/][Firefox extension from addons.mozilla.org]].
...
You can install [[https://addons.mozilla.org/firefox/addon/linkremark/][Firefox extension from addons.mozilla.org]].
